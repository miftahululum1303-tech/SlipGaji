...
<div class="sidebar-premium vh-100 shadow d-flex flex-column" id="sidebar-wrapper">
    ...
    <div class="brand-wrapper p-4 border-bottom border-secondary border-opacity-25 d-flex align-items-center gap-2">
        ...
        <div>
            <h6 class="fw-bold text-white mb-0 text-uppercase tracking-wider"
                style="font-size: 12px; letter-spacing: 0.5px;">Payroll System</h6>
        ...
        <ul class="nav flex-column gap-1">
            ...
            <li class="nav-item">
                <a class="nav-link d-flex justify-content-between align-items-center collapsed"
                    data-bs-toggle="collapse" href="#menuMaster" role="button" aria-expanded="false">
            ...
            <li class="nav-item">
                <a class="nav-link d-flex justify-content-between align-items-center collapsed"
                    data-bs-toggle="collapse" href="#menuTransaksi" role="button" aria-expanded="false">
                    <div class="d-flex align-items-center gap-2">
...
<style>
    ...
    .sidebar-premium .nav-link-sub:hover {
        ...
        /* Warna cyan cerah saat sub-menu di-hover */

...
if (isset($_POST['simpan_profil'])) {
    ...
    if ($error_foto === 0) {
        ...
        if (move_uploaded_file($tmp_foto, $jalur_simpan)) {
            $query_update = "UPDATE user SET nama='$nama', email='$email', foto='$nama_foto_baru' WHERE id_user='$id_user_login'";
        ...
        $query_update = "UPDATE user SET nama='$nama', email='$email' WHERE id_user='$id_user_login'";
        $eksekusi     = mysqli_query($koneksi, $query_update);
...
// ==========================================
$id_aktif = 1; 
$ambil_data = mysqli_query($koneksi, "SELECT * FROM user WHERE id_user='$id_aktif'");
        ...
        <div class="card card-premium text-center p-4 rounded-4 h-100">
            <div class="card-body d-flex flex-column align-items-center justify-content-center">
                <div class="profile-avatar-wrapper mb-3 position-relative">
                    <img src="<?= $foto_profil_sekarang; ?>" 
                         alt="Avatar" 
                         class="rounded-circle img-thumbnail avatar-premium-border p-2" 
                         style="width: 130px; height: 130px; object-fit: cover;">
                    <span class="position-absolute bottom-0 end-0 bg-info p-2 border border-3 border-card rounded-circle animation-pulse" title="Online"></span>
                </div>
                ...
                <p class="text-premium-muted font-monospace m-0" style="font-size: 11px;">Miftahul Ulum Payroll System v1.0</p>
            </div>
        </div>
    </div>
        ...
        <div class="card card-premium p-4 rounded-4">
            <div class="d-flex align-items-center gap-2 mb-4 pb-2 border-bottom border-light-subtle">
                ...
                <div>
                    ...
                    <p class="text-premium-muted small m-0">Perbarui data personal akun operasional Anda secara berkala.</p>
                </div>
            </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group input-group-premium">
                            ...
                            <input type="text" name="nama_lengkap" class="form-control" value="<?= $nama_sekarang; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group input-group-premium">
                            ...
                            <input type="email" name="email" class="form-control" value="<?= $email_sekarang; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group input-group-premium disabled-premium">
                            ...
                            <input type="text" class="form-control" value="Sistem Manajer" readonly disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-2">
                        ...
                        <div class="form-text text-premium-muted" style="font-size: 11px;">Format: JPG, PNG. Maksimal ukuran file 2 MB.</div>
                    </div>
                    ...
                    <div class="col-md-12 d-flex justify-content-end gap-2 pt-3 border-top border-light-subtle">
                        ...
                        <button type="submit" name="simpan_profil" class="btn btn-premium-primary btn-sm fw-bold px-4 rounded-pill shadow-sm">
...
.text-premium-dark { color: #1e293b !important; }
.text-premium-muted { color: #64748b !important; }
.text-premium-label { color: #475569 !important; }
.line-premium-separator { border-color: rgba(34, 45, 74, 0.1) !important; }
.border-card { border-color: #ffffff !important; }
.bg-midnight-icon { background-color: #222d4a !important; }
...
.avatar-premium-border { border-color: rgba(34, 45, 74, 0.15) !important; }

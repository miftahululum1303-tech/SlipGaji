...
if (isset($_POST['simpan_transaksi'])) {
    ...
    $cek = mysqli_query($koneksi, "SELECT * FROM transaksi_golongan WHERE nik = '$nik'");
    if (mysqli_num_rows($cek) > 0) {
        ...
        $insert = mysqli_query($koneksi, "INSERT INTO transaksi_golongan (nik, id_golongan) VALUES ('$nik', '$id_golongan')");
...
if (isset($_GET['action']) && $_GET['action'] == 'hapus') {
    ...
    $hapus = mysqli_query($koneksi, "DELETE FROM transaksi_golongan WHERE id_transaksi_gol='$id_hapus'");
    if ($hapus) {
...
<div class="card border-0 shadow-sm bg-white rounded-3">
    ...
    <div class="card-header bg-white border-0 pt-4 pb-2 d-flex justify-content-between align-items-center flex-wrap gap-2">
        <div>
            ...
            <p class="text-muted small m-0 mt-1">Hubungkan Nomor Induk Karyawan dengan standarisasi golongan yang berlaku.</p>
        </div>
        
        <button class="btn btn-primary fw-bold btn-sm px-3 shadow-sm d-flex align-items-center gap-2" 
                type="button" data-bs-toggle="collapse" data-bs-target="#collapseFormTransaksi" 
                aria-expanded="false" aria-controls="collapseFormTransaksi">
                ...
                <form method="POST" action="">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="input-group">
                                ...
                                <select name="nik" class="form-select border-start-0" required>
                                    ...
                                    if(!$q_kry) {
                                        // Fallback jika nama tabelnya 'user'
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-white text-muted border-end-0"><i class="fa-solid fa-layer-group small"></i></span>
        ...
        <div class="table-responsive">
            <table id="tabelTransaksiGolongan" class="table table-hover table-striped align-middle w-100 m-0">
                ...
                <tbody>
                    ...
                    $sql = mysqli_query($koneksi, "SELECT tg.*, g.nama_golongan 
                                                   FROM transaksi_golongan tg
                                                   INNER JOIN golongan g ON tg.id_golongan = g.id_golongan 
                                                   ORDER BY tg.id_transaksi_gol DESC");
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center pe-3">
                                <a href="index.php?page=transaksi_golongan&action=hapus&id=<?= $row['id_transaksi_gol']; ?>" 
                                   onclick="return confirm('Hapus pemetaan golongan untuk NIK <?= $row['nik']; ?>?');" 

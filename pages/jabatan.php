...
if (isset($_POST['simpan_jabatan'])) {
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO jabatan (nama_jabatan) VALUES ('$nama_jabatan')");
    ...
    <div class="card-header bg-white border-0 pt-4 pb-2 d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <div class="d-flex gap-2">
            <button class="btn btn-primary fw-bold btn-sm px-3 shadow-sm d-flex align-items-center gap-2" 
                    type="button" data-bs-toggle="collapse" data-bs-target="#collapseFormJabatan" 
                    aria-expanded="false" aria-controls="collapseFormJabatan">
                    ...
                    <div class="row g-3 align-items-end">
                        <div class="col-md-9">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="nama_jabatan" class="form-control border-start-0" placeholder="Contoh: Direktur Utama / Manajer Keuangan / Staff Administrasi" required>
                            </div>
                        </div>
            ...
            <table id="tabelJabatan" class="table table-hover table-striped align-middle w-100 m-0">
                ...
                <tbody>
                    ...
                    if ($sql && mysqli_num_rows($sql) == 0) {
                        echo "<tr><td colspan='3' class='text-center text-muted py-4 fw-medium bg-light'><i class='fa-solid fa-folder-open me-2 text-secondary'></i>Belum ada data jabatan terdaftar. Klik tombol di atas untuk menambah.</td></tr>";
                    }

...
if (isset($_POST['simpan_golongan'])) {
    ...
    $insert = mysqli_query($koneksi, "INSERT INTO golongan (nama_golongan, tunjangan_golongan) VALUES ('$nama_golongan', '$tunjangan_golongan')");
    ...
    <div
        ...
        <div class="d-flex gap-2">
            <button class="btn btn-primary fw-bold btn-sm px-3 shadow-sm d-flex align-items-center gap-2" type="button"
                data-bs-toggle="collapse" data-bs-target="#collapseFormGolongan" aria-expanded="false"
                aria-controls="collapseFormGolongan">
                    ...
                    <div class="row g-3 align-items-end">
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-white text-muted border-end-0"><i
                                        class="fa-solid fa-tags small"></i></span>
                                <input type="text" name="nama_golongan" class="form-control border-start-0"
                                    placeholder="Contoh: Golongan I / Golongan II / Eksekutif" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="tunjangan_golongan" class="form-control border-start-0"
            ...
            <table id="tabelGolongan" class="table table-hover table-striped align-middle w-100 m-0">
                ...
                <tbody>
                    ...
                    if ($sql && mysqli_num_rows($sql) == 0) {
                        echo "<tr><td colspan='4' class='text-center text-muted py-4 fw-medium bg-light'><i class='fa-solid fa-folder-open me-2 text-secondary'></i>Belum ada data golongan terdaftar. Klik tombol di atas untuk menambah.</td></tr>";
                    }
